...
def get_args():
    ...
    parser.add_argument('--train_num', '-trnum', default=None, type=int, help='Number of training data')
    parser.add_argument('--test_num', '-tenum', default=None, type=int, help='Number of test data')
