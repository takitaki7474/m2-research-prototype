...
class Cifar10_Conv6(chainer.Chain):

    def __init__(self, n_out=3):
        super(Cifar10_Conv6, self).__init__()
...
class Cifar10_Conv4(chainer.Chain):

    def __init__(self, n_out=3):
        super(Cifar10_Conv4, self).__init__()
        with self.init_scope():
            self.conv1 = L.Convolution2D(None, 32, 3, 3, 1)
            self.conv2 = L.Convolution2D(32, 32, 3, 3, 1)
            self.conv3 = L.Convolution2D(32, 32, 3, 3, 1)
...
class Cifar10_Conv2(chainer.Chain):

    def __init__(self, n_out=3):
        super(Cifar10_Conv2, self).__init__()
        with self.init_scope():
            self.conv1 = L.Convolution2D(None, 32, 3, 3, 1)
            self.conv2 = L.Convolution2D(32, 32, 3, 3, 1)
            self.fc1 = L.Linear(None, 512)
